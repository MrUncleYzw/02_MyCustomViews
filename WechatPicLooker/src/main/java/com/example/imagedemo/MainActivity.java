...
public class MainActivity extends Activity {
	...
	/** Item数据实体集合 */
	private ArrayList<UserBean> itemEntities;
	/** ListView对象 */
	...
	private void initData() {
		...
		itemEntities.add(userBean1);
		// 2.1张图片
		ArrayList<String> urls_1 = new ArrayList<>();
		...
		itemEntities.add(userBean2);
		// 3.3张图片
		ArrayList<String> urls_2 = new ArrayList<>();
		...
		itemEntities.add(userBean3);
		// 4.6张图片
		ArrayList<String> urls_3 = new ArrayList<>();
