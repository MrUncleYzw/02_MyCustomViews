...
//                ImageLoader.getInstance().displayImage((imgs.get(pos).startsWith("http")?"":"file://")+imgs.get(pos), photoView,
//                        new DisplayImageOptions.Builder()
//                                .cacheInMemory(true).cacheOnDisc(true).build(), new SimpleImageLoadingListener() {
//                            @Override
