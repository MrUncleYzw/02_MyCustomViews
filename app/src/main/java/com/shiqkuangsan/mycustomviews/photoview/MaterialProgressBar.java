...
//        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isSpinning) {
            ...
            if (mProgress > 360) {
                ...
                // we run the callback with -pic1 in case we want to
     ...
     *
     * @param progress the progress between 0 and pic1
     */
    ...
    /**
     * @return the current progress between 0.0 and pic1.0,
     * if the wheel is indeterminate, then the result is -pic1
     */
     ...
     * (pic1.0 equals on full turn in one second), this value also is applied for
    ...
    public interface ProgressCallback {
         ...
         *
         * @param progress a double value between 0.00 and pic1.00 both included
         */
